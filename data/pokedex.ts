export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	hydreigon: {
		...
		name: "Hydreigon",
		types: ["Fire", "Dragon"],
		baseStats: { hp: 92, atk: 85, def: 90, spa: 145, spd: 90, spe: 108 },
		abilities: { 0: "Levitate" },
		heightm: 1.8,
		weightkg: 160,
		color: "Blue",
	...
	volcarona: {
		...
		name: "Volcarona",
		types: ["Steel"],
		baseStats: { hp: 85, atk: 60, def: 105, spa: 125, spd: 105, spe: 100 },
		abilities: { 0: "Swarm", H: "Magic Bounce" },
		heightm: 1.6,
		weightkg: 46,
		color: "White",
	...
	kingambit: {
		...
		name: "Kingambit",
		types: ["Bug", "Steel"],
		baseStats: { hp: 100, atk: 135, def: 120, spa: 60, spd: 85, spe: 85 },
		abilities: { 0: "Defiant", 1: "Supreme Overlord", H: "Intrepid Sword" },
		heightm: 2,
		weightkg: 120,
		color: "Black",
		prevo: "Bisharp",
